...
class CompositeTIF(QtWidgets.QMainWindow):
    ...
    def __init__(self, main_viewer: MainViewer, ui_path: str):
        ...
        self.setWindowTitle("Composite TIF creation")

# function for amp plugin building
def build_as_plugin(main_viewer: MainViewer, plugin_path: str) -> CompositeTIF:
    """ Returns an instance of CompositeTIF
    ...
    return CompositeTIF(main_viewer, plugin_path)